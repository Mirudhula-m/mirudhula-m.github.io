...
As a Master's student in Computational Biology at Carnegie Mellon University, I am passionate about using data-driven approaches to improve our understanding of complex biological and health phenomena. My interest lies in modeling and analyzing large datasets from biological and health domains to extract meaningful insights that can advance our understanding of disease mechanisms and inform clinical decision-making.

I apply cutting-edge Machine/Deep Learning techniques to handle noise and complexity in biological and health data to uncover hidden patterns and relationships. I'm interested in exploring novel deep learning architectures, such as convolutional and recurrent neural networks, to model temporal and spatial relationships in complex biological systems.

I aim to utilize the full potential of computational biology in creating diagnostic tools, therapies, and preventive measures that can significantly enhance our health outcomes and overall quality of life. I am thrilled to delve into the convergence of biology, data science, and machine learning in this dynamic and rapidly-evolving field.
